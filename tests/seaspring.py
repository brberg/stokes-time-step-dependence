...
for j in range(len(Solvers)):
    ...
    Solvers[j] = SimulationSolver(xz_boundary, 1E-9, 3.5E-25*seconds_per_year, 9800, lores, hires, 4000, False) #geometry, picard solver relative tolerance, glen's flow law parameter, high resolution start distance, low resolution, high resolution, inflow velocity (m/s), include_inertial_term
